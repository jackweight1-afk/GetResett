      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center relative">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="block">
              <span className="bg-gradient-to-r from-emerald to-purple-600 bg-clip-text text-transparent font-black text-5xl md:text-7xl">One Minute</span> at a Time
            </span>
          </h1>
          <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="bg-gradient-to-r from-emerald to-purple-600 bg-clip-text text-transparent font-bold">Join 10,000+ people who reset daily.</span>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg"
              onClick={() => window.location.href = '/api/login'}
              className="bg-gradient-to-r from-emerald to-purple-600 hover:from-emerald/90 hover:to-purple-700 text-white text-lg px-10 py-4 shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 font-semibold"
            >
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-emerald text-emerald hover:bg-emerald hover:text-white text-lg px-10 py-4 font-semibold hover:shadow-lg transition-all"
            >
              See How It Works
            </Button>
          </div>
        ...
        <div className="bg-gradient-to-r from-gray-50 via-white to-gray-50 border border-gray-200 rounded-3xl p-12 text-center mt-24 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">Join <span className="bg-gradient-to-r from-emerald to-purple-600 bg-clip-text text-transparent font-bold">10,000+ people</span> who've made wellness effortless with Reset.</p>
            <Button 
              size="lg"
              onClick={() => window.location.href = '/api/login'}
              className="bg-gradient-to-r from-emerald to-purple-600 hover:from-emerald/90 hover:to-purple-700 text-white text-xl px-12 py-5 shadow-2xl hover:shadow-3xl transition-all transform hover:scale-105 font-bold rounded-2xl"
            >
              Create Free Account
            </Button>
          </div>
