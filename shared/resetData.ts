...
export const RESETS: Reset[] = [
  ...
  // ============ ENERGY TO BURN (4 resets) ============
  {
    ...
    interactiveSteps: [
      ...
      { title: 'Stretch: Neck Rolls', instruction: 'SETUP & MOVE: Stand tall, shoulders down. Drop chin to chest, then slowly roll your head in a full circle—right, back, left, forward. Do 3 smooth circles clockwise, pause, then 3 circles counterclockwise. BREATH & FORM: Inhale as you roll back, exhale rolling forward. Move slowly, no jerking. Feel the gentle stretch releasing tension. SAFETY & OPTIONS: Keep it smooth and controlled, never force the movement.', duration: 15, input: 'movement', isStretch: true },
      { title: 'Stretch: Arm Circles', instruction: 'SETUP & MOVE: Stand with feet shoulder-width, extend arms straight out to sides at shoulder height. Make large circles forward 5 times (draw big hoops!), then reverse backward 5 times. Keep arms straight but elbows soft. BREATH & FORM: Breathe naturally and steady. Shoulders stay down, not hunched. Core engaged for stability. SAFETY & OPTIONS: Make big circles, not tiny ones. Feel warmth building in shoulders and upper back.', duration: 15, input: 'movement', isStretch: true },
      { title: 'Stretch: Torso Twists', instruction: 'SETUP & MOVE: Stand with feet hip-width, knees soft, hands on hips. Keep hips forward, twist torso right as far as comfortable. Return to center, twist left. Do 6 reps per side. BREATH & FORM: Exhale as you twist, inhale returning to center. Rotate from waist not hips. Core engaged, shoulders level. SAFETY & OPTIONS: Move within comfortable range, don\'t force it. Feel gentle stretch in obliques and lower back.', duration: 15, input: 'movement', isStretch: true },
      
      // Main workout
      { title: 'Jumping Jacks', instruction: 'SETUP & MOVE: Stand tall, feet together, arms relaxed. Make sure you have room overhead. Jump feet wider than shoulders while sweeping arms into a soft Y. Land light with knees soft, then spring feet back together, arms down. Aim for a steady 30-second rhythm. BREATH & FORM: Inhale as you open, exhale as you close. Brace your core, keep shoulders loose, eyes forward. SAFETY & OPTIONS: Stop if you feel light-headed or joints complain. Prefer low-impact? Step side-to-side while lifting arms overhead.', duration: 30, input: 'movement', visualAid: '/movement/jumping-jacks.png', alternativeMove: 'Step side-to-side instead of jumping, raising arms with each step' },
      { title: 'High Knees', instruction: 'SETUP & MOVE: Stand tall, arms bent at 90 degrees. Run in place, driving each knee up to waist level. Alternate knees rapidly, pumping opposite arm to knee. Aim for 40-50 total knee lifts in 20 seconds. BREATH & FORM: Quick, natural breaths matching your pace. Stay on balls of feet, light and bouncy. Core engaged, chest up, eyes forward. Drive knees UP, not just forward. SAFETY & OPTIONS: Land lightly to protect knees. Prefer gentle? March in place with controlled knee lifts.', duration: 20, input: 'movement', alternativeMove: 'March in place at moderate pace with controlled knee lifts' },
      { title: 'Bodyweight Squats', instruction: 'SETUP & MOVE: Stand feet shoulder-width, toes slightly out. Arms forward for balance. Push hips back like sitting in a chair, lower until thighs parallel to floor (or as low as comfortable). Drive through heels to stand, squeeze glutes at top. Do 10 controlled reps. BREATH & FORM: Inhale down, exhale up. Chest proud, weight in heels not toes. Core engaged, knees push out not inward. SAFETY & OPTIONS: Only go as low as comfortable. Stop if knee or back pain. Hold chair for balance or reduce depth as needed.', duration: 25, input: 'movement', visualAid: '/movement/squats.png', alternativeMove: 'Hold onto chair for balance, reduce squat depth to comfort level' },
      { title: 'Arm Pulses', instruction: 'SETUP & MOVE: Stand feet hip-width, extend both arms straight forward at shoulder height, palms down. Make small, rapid up-and-down pulses (3-4 inches range). Keep arms extended straight, no bending elbows. Pulse continuously for 20 seconds. BREATH & FORM: Breathe naturally and steady—don\'t hold breath. Shoulders down, not hunched. Arms parallel to ground, core tight. SAFETY & OPTIONS: Push through the burn—this builds shoulder endurance! Keep arms at height, don\'t let them drop.', duration: 20, input: 'movement' },
      ...
      { title: 'Burpees (Modified)', instruction: 'SETUP & MOVE: Stand feet shoulder-width. Bend knees, place hands on floor. Step right foot back, then left into plank (hands under shoulders, body straight). Hold 1 second. Step forward to squat, stand up and reach overhead. That\'s 1 rep—do 5 total. BREATH & FORM: Exhale stepping back, inhale in plank, exhale stepping forward, inhale reaching up. Quality over speed. Keep plank straight, core engaged, no sagging hips. SAFETY & OPTIONS: This is challenging! Take breaks as needed. Too much? Skip plank—just squat, touch floor, stand and reach up.', duration: 25, input: 'movement', alternativeMove: 'Squat down, touch floor, stand up and reach overhead—skip the plank step entirely' },
  ...
  },
  {
    ...
    interactiveSteps: [
      ...
      // Stretch section
      { title: 'Stretch: Shoulder Rolls', instruction: 'SETUP & MOVE: Stand feet hip-width, arms loose. Lift shoulders up, roll them BACK and DOWN in smooth circles. Do 5 rolls backward, then reverse direction for 5 forward rolls. BREATH & FORM: Inhale as shoulders rise, exhale rolling down. Slow, controlled movements. Feel tension releasing. SAFETY & OPTIONS: Don\'t rush—take your time. Loosens shoulders and upper traps before punching.', duration: 12, input: 'movement', isStretch: true },
      { title: 'Stretch: Wrist Circles', instruction: 'SETUP & MOVE: Make loose fists, arms extended forward. Rotate wrists in full circles—5 clockwise, then 5 counterclockwise. Move slowly through complete range of motion. BREATH & FORM: Breathe naturally. Make full circles, not tiny ones. Your wrists need warming up for punching. SAFETY & OPTIONS: Prevents wrist strain during punching. Protects your joints.', duration: 12, input: 'movement', isStretch: true },
      { title: 'Stretch: Hip Circles', instruction: 'SETUP & MOVE: Feet shoulder-width, hands on hips, knees soft. Keep feet planted, circle hips smoothly—3 slow circles clockwise (draw circles with your hips), then 3 counterclockwise. BREATH & FORM: Breathe steadily. Isolate the movement—hips only, not upper body. Feel rotation loosening lower back. SAFETY & OPTIONS: Warms up core rotation for powerful punches.', duration: 12, input: 'movement', isStretch: true },
      
      // Boxing movements
      { title: 'Stance', instruction: 'SETUP & MOVE: Feet shoulder-width. If right-handed, step left foot slightly forward (reverse if southpaw). Knees bent, weight on balls of feet. Raise fists to chin, elbows tucked protecting ribs. Lead hand slightly forward, rear hand by cheek. BREATH & FORM: Natural, steady breaths. Chin down for protection. Shoulders relaxed but ready, core engaged. Stay light on your feet. SAFETY & OPTIONS: This is home base—return here after every punch. Gives you balance, power, and protection.', duration: 10, input: 'movement', visualAid: '/movement/boxing-stance.png' },
      { title: 'Jab Practice', instruction: 'SETUP & MOVE: From stance, lead hand at chin. Snap lead hand straight forward, rotating fist palm-down at full extension. Immediately snap back to guard. Do 20 quick jabs. BREATH & FORM: Exhale sharply with each jab. Punch straight not looping. Shoulder up to protect chin, other hand at guard. Rotate from shoulder, extend fully. Quick and snappy! SAFETY & OPTIONS: Don\'t drop guard hand or telegraph. This is your fastest punch—snap it!', duration: 20, input: 'movement', visualAid: '/movement/jab.png' },
      { title: 'Cross Punches', instruction: 'SETUP & MOVE: From stance, rear hand by cheek. Throw rear hand straight across body toward target. Rotate hips and shoulders—pivot rear foot, heel lifts. Extend arm fully, fist palm-down. Snap back to guard. Do 15 crosses. BREATH & FORM: Explosive exhale with each cross. Power comes from rotation not just arm. Front hand stays up! Drive from back foot, full hip rotation, chin protected. SAFETY & OPTIONS: Powerful but controlled. Don\'t drop lead hand or overextend. This is your power punch!', duration: 18, input: 'movement', visualAid: '/movement/cross-punch.png' },
      { title: 'Jab-Cross Combo', instruction: 'SETUP & MOVE: Combine jab and cross. From stance: (1) Snap lead jab straight out. (2) Immediately follow with rear cross, rotating hips. (3) Both hands to guard. That\'s 1 combo—do 10 total. BREATH & FORM: Sharp exhale on EACH punch (two breaths per combo). Find your rhythm: Jab-Cross, Jab-Cross. Stay balanced, reset to stance between combos. Lead hand up while throwing cross. Light on feet, small bounce. SAFETY & OPTIONS: Don\'t rush—take your time. Don\'t drop guard between punches. This is fundamental boxing—flow!', duration: 20, input: 'movement' },
      { title: 'Hooks', instruction: 'SETUP & MOVE: Return to stance. Lead hook: Elbow bent 90 degrees, rotate from waist and shoulders, swing arm in horizontal arc at shoulder level. Pivot front foot. Do 10 lead hooks. Then rear hook: same motion with rear hand, pivot back foot, full hip rotation. Do 10 rear hooks. BREATH & FORM: Exhale with each hook. Hook comes from rotation not arm swing. Other hand at guard, chin protected. Weight shifts into punch. Controlled power. SAFETY & OPTIONS: Don\'t swing wildly—use technique. Rotating entire body builds core strength!', duration: 20, input: 'movement' },
      { title: 'Speed Round', instruction: 'SETUP & MOVE: Final push! For 15 seconds, throw ANY punches as fast as you can. Mix jabs, crosses, hooks—whatever feels good! Speed and volume. Let your energy OUT! BREATH & FORM: Quick, sharp exhales with every punch. Try to maintain technique at speed, but intensity is priority. Stay on toes, move feet, imagine hitting targets. SAFETY & OPTIONS: Stay controlled—don\'t hyperextend or hurt yourself. This is your explosive finish—give it everything!', duration: 15, input: 'movement' },
  ...
  },
  {
    ...
    interactiveSteps: [
      ...
      // Stretch section
      { title: 'Stretch: Standing Side Bend', instruction: 'SETUP & MOVE: Stand feet hip-width, arms at sides. Reach RIGHT arm overhead, gently bend upper body LEFT creating side curve. Hold 5 seconds breathing into right ribs. Return center, lower arm. Repeat opposite: LEFT arm up, bend RIGHT. Do 2 full cycles (4 total bends). BREATH & FORM: Inhale reaching up, exhale bending, breathe steadily during hold. Pure side bend—don\'t lean forward/back. Hips stable, core gently engaged. SAFETY & OPTIONS: Feel stretch from hip to armpit. Opens side body for dynamic movement.', duration: 15, input: 'movement', isStretch: true, visualAid: '/movement/side-bend.png' },
      { title: 'Stretch: Forward Fold', instruction: 'SETUP & MOVE: Stand feet hip-width, knees soft (slightly bent). Hinge forward at hips, let torso fold down. Arms and head hang heavy toward floor—surrender to gravity. Hold 8 seconds, relax completely. BREATH & FORM: Exhale folding down, breathe naturally during hold. Each exhale, relax deeper. Bend knees generously if tight. Let gravity work—don\'t force. Relax neck, jaw, shoulders. SAFETY & OPTIONS: Feel gentle stretch in hamstrings and lower back. To come up, bend knees more and roll up slowly.', duration: 12, input: 'movement', isStretch: true },
      
      // Breath + movement
      { title: 'Reach & Squat', instruction: 'SETUP & MOVE: Stand feet shoulder-width. (1) INHALE: Reach both arms straight overhead—stretch tall. (2) EXHALE: Push hips back, lower into squat, arms forward for balance. (3) INHALE: Press through heels, stand, reach overhead again. Do 8 reps. BREATH & FORM: Your breath powers movement. INHALE = reach up (expand), EXHALE = squat down (contract). Never hold breath. Full breath each rep. Chest up in squat, weight in heels, core engaged. Match your natural breath pace. SAFETY & OPTIONS: Smooth and rhythmic. Energy and breath become one.', duration: 25, input: 'movement' },
      { title: 'Lunge & Twist', instruction: 'SETUP & MOVE: Stand tall. Step RIGHT foot forward into lunge (both knees 90 degrees, back knee hovering). INHALE: Reach arms overhead. EXHALE: Twist torso RIGHT (toward front leg), arms down to sides. INHALE: Return center, arms up. Step back to standing. Do 4 times right leg, then 4 times left leg. BREATH & FORM: Deep inhale UP, full exhale TWIST. Front knee over ankle not past toes. Back knee hovers. Twist from waist, keep hips square. SAFETY & OPTIONS: Stop if knee pain. Hold chair for balance or reduce lunge depth as needed.', duration: 30, input: 'movement', visualAid: '/movement/lunge-twist.png', alternativeMove: 'Hold chair for balance or reduce lunge depth to comfort level' },
      { title: 'Plank Hold', instruction: 'SETUP & MOVE: Start on hands and knees. Place hands under shoulders. Step feet back into plank—body forms straight line head to heels. Hold 15 seconds. BREATH & FORM: Breathe steadily and fully—do NOT hold breath! Inhale through nose, exhale through mouth. Count breaths. Engage core (belly to spine). Neutral spine—don\'t sag hips or pike butt up. Shoulders over wrists, gaze at floor between hands. Press away from floor. SAFETY & OPTIONS: If wrists hurt, go to forearms. Too hard? Drop to knees keeping shoulders-to-knees straight.', duration: 15, input: 'movement', visualAid: '/movement/plank.png', alternativeMove: 'Do plank from knees, keeping upper body and thighs in straight line' },
      { title: 'Mountain Climbers', instruction: 'SETUP & MOVE: From plank, hands under shoulders, body straight. Bring RIGHT knee toward chest. Quickly switch—extend right leg back while bringing LEFT knee to chest. Continue alternating rapidly. Do 10 reps per leg (20 total knee drives). BREATH & FORM: Quick, rhythmic breaths matching pace. Don\'t hold breath! Start controlled, build to faster pace—like running in plank. Keep hips level (don\'t bounce). Core engaged, hands planted firmly. Land ball of foot softly. SAFETY & OPTIONS: Protect wrists—keep hands planted. Prefer gentler? Step slowly instead of running motion.', duration: 20, input: 'movement', visualAid: '/movement/mountain-climbers.png', alternativeMove: 'Step knees forward slowly one at a time, controlled pace instead of running' },
      { title: 'Standing Twist', instruction: 'SETUP & MOVE: Stand feet hip-width, arms extended forward at chest height, palms together. (1) INHALE: Stay centered, lengthen spine. (2) EXHALE: Twist torso RIGHT, arms with torso (palms together). (3) INHALE: Return center. (4) EXHALE: Twist LEFT. Do 6 complete cycles (12 twists total). BREATH & FORM: Breath controls everything. Inhale to prepare, exhale to twist. Twist from waist and mid-back not hips. Hips stable facing forward. Arms at chest height, shoulders level, core engaged. Slow and controlled. SAFETY & OPTIONS: Gentle spinal rotation, breath filling lungs, energy centering.', duration: 18, input: 'movement' },
  ...
  },
  {
    ...
    interactiveSteps: [
      ...
      // Stretch section
      { title: 'Stretch: Ankle Rolls', instruction: 'SETUP & MOVE: Stand on one leg (hold wall or chair for balance if needed). Lift RIGHT foot slightly off ground. Rotate ankle in slow circles—5 clockwise feeling full range, then 5 counterclockwise. Lower right foot, switch to LEFT and repeat (5 each direction). BREATH & FORM: Breathe naturally and steadily. Slow, controlled circles. Draw circles with toes not whole leg. Warms up ankle joints and improves balance. SAFETY & OPTIONS: Don\'t rush—take your time with each circle. Prepares ankles for walking and prevents injury.', duration: 15, input: 'movement', isStretch: true },
      { title: 'Stretch: Leg Swings', instruction: 'SETUP & MOVE: Stand next to wall or chair, hold on with RIGHT hand for balance. Swing LEFT leg forward and back like pendulum—smooth, controlled swings. Do 5 swings (forward counts as 1). Keep standing leg slightly bent. Switch sides: hold LEFT hand, swing RIGHT leg 5 times. BREATH & FORM: Exhale as leg swings forward, inhale swinging back. Control the swing—don\'t fling wildly. Torso upright, don\'t lean. Standing leg stable, swing from hip joint. SAFETY & OPTIONS: Feel gentle dynamic stretch in hamstrings and hip flexors. Loosens hip joints for walking.', duration: 15, input: 'movement', isStretch: true },
