...
import { Building2, Users, Activity, TrendingUp, DollarSign, Calendar, Mail, Phone, ArrowLeft, RefreshCw, Shield } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  if (analyticsLoading || orgsLoading || leadsLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          <RefreshCw className="w-8 h-8 animate-spin mx-auto mb-4 text-purple-600" />
