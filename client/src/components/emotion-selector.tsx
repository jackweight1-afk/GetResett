        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
          <div className="text-xs sm:text-sm text-muted-foreground w-full sm:w-auto">
            {showRemainingSessions && (
              <span className="bg-card border border-border/50 px-3 sm:px-4 py-2 rounded-xl shadow-elegant inline-block">
          ...
          <div className="flex gap-2 w-full sm:w-auto justify-end">
            <Button
              ...
              className="bg-card border border-border/50 hover:bg-muted text-xs sm:text-sm"
            ...
            ([emotion, info], index) => {
              ...
              return (
                <motion.button
                  ...
                  className="group relative bg-card rounded-3xl p-6 sm:p-8 
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br ${info.color} 
                                   flex items-center justify-center mb-4 shadow-elegant group-hover:shadow-elegant-lg
